          ...
          if($inc){
            ...
            while($row =mysqli_fetch_assoc($resultado)){ 
              ...
              <tr>               
                ...
                <td class="renglon">
                <?php echo "<a href='modificar_inform.php?id_formulario=".$row['id_formulario']."' class='uno'> Modify </a>"; ?>
                <?php echo "<a href='PHP/eliminar_infor.php?id_formulario=".$row['id_formulario']."' class='dos' onclick='return confirmar()'>Eliminate</a>"; ?>  
                </td>
              </tr>
              <?php
            }           
